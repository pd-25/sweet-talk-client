                            ...
                            <div className="modal-dialog">
                                <div className="modal-content">
                                    <div className="modal-body modal-body-dms">
                                        ...
                                        <button type="button" className="btn mt-2 gr add-btn-dms" data-bs-toggle="modal" data-bs-target="#add-coworker-btn1">
                                            <i className="fa-solid fa-plus pt-1"></i>
                                        </button>
                                        <div className="modal fade" id="add-coworker-btn1" tabIndex="-1" aria-labelledby="add-coworker-btn1-label" aria-hidden="true">
                                            ...
                                            <div className="dms-main-inner">
                                                ...
                                                <div className="select-btns-activity d-flex justify-content-between" style={{ marginTop: '55px' }}>
                                                    ...
                                                    <div className="add-channels-btn-modal">
                                                        <button type="button" className="btn gr add-btn-activity" data-bs-toggle="modal" data-bs-target="#add-channel-btn1">
                                                            <i className="fa-solid fa-plus"></i>
                                                        </button>

                                                        <div className="modal fade" id="add-channel-btn1" tabIndex="-1" aria-labelledby="add-channel-btn-label" aria-hidden="true">
                                                            <div className="modal-dialog modal-dialog-centered">
                                                                <div className="modal-content">
                                                                    <form action='#' method='' className="modal-body">
